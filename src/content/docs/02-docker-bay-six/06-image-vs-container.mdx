...
<img
  src="/assets/lessons/02-docker-bay-six/06-image-vs-container-layers.png"
  alt="Technical layer diagram showing a Docker Image as locked read-only layers and a Running Container as those identical layers topped with an active writable layer"
  width="1600"
  loading="lazy"
/>
