...
<img
  src="/assets/lessons/02-docker-bay-six/00-welcome-to-the-docker-bay.png"
  alt="A comparison of the Docker Ecosystem vs the chaos of loose development workflow"
  width="1600"
  loading="lazy"
/>

_Figure 1: The Docker Ecosystem vs the chaos of loose development workflow_
...
Never, ever, ever say "it works on my machine" again.
