...
<NoteBox title="Why are we using `start` here?">
...
<img
  src="/assets/lessons/02-docker-bay-six/11-docker-build-output.png"
  alt="Building the Image"
/>

_Figure 1: Building the Image_
...
<img
  src="/assets/lessons/02-docker-bay-six/11-docker-desktop-built-image.png"
  alt="Docker Desktop Built Image"
/>

_Figure 2: The Docker Desktop Built Image_
