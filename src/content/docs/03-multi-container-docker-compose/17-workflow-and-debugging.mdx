...
<img
  src="/assets/lessons/03-multi-container-docker-compose/17-debugging-workflow-loop.png"
  alt="Workflow diagram showing a circular loop of debugging steps: Status (ps), Logs (logs), Config (env/yaml), Exec (sh/mongosh), and Reset (up --build). A container with a warning icon is in the center."
  width="1600"
  loading="lazy"
/>
