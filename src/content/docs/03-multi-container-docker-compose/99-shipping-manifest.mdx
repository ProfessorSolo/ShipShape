...
<LinkButton
  href="/assets/resources/slide-decks/03-multi-container-docker-compose/Orchestrating_the_Fleet.pdf"
  icon="external"
  variant="secondary"
  target="_blank"
>
...
<LinkButton
  href="https://github.com/ProfessorSolo/ShipShape-03-01-Docker-Compose.git"
  icon="external"
  variant="primary"
  target="_blank"
>
